...
export async function GET(req: Request) {
    try {
        ...
        // Inside your GET in src/app/api/dates/route.ts
...
export async function POST(req: Request) {
    try {
        ...
        let imageFile: File | null = null; // only for multipart uploads
        ...
        if (contentType.includes("multipart/form-data")) {
            ...
            date_time = (formData.get("date_time") as string) ?? null; // ISO string ideally
        ...
        // ---------- get/create profile for this user ----------
