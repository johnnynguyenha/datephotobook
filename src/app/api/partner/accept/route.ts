...
export async function POST(req: Request) {
    ...
    try {
        ...
        // 1) Load the notification and ensure it belongs to user_id
      ...
      `,
        ...
        // 2) Load both users and lock them
      ...
      `,
        ...
        // 3) Ensure BOTH still have no partner
        ...
        // 4) Update both users to reference each other
        await client.query(
